...
| --- | --- | --- |
| John Lloyd Villarias | Project Manager | Plans the project, assigns tasks, and monitors progress |
| John Noe Gonzales | Lead Developer | Designs the system, codes features, and reviews work |
| Meljephine Chequito | Business Analyst | Gathers requirements and documents user needs |
